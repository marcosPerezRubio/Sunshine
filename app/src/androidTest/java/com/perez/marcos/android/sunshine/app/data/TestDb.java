...
import com.perez.marcos.sunshine.data.WeatherDbHelper;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        assertTrue("Error: No Records returned from location query", c.moveToFirst());
        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEnty failed to validate", c , weatherValues);
        assertFalse("Error: More than one record returned from location query", c.moveToNext());
